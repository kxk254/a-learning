...
const TextArea: ReactFC<TextareaProps> = ({
  ...
  if (disabled) {
    textareaClasses += `be-gray-100 opacity-50 text-gray-500 border-gray-300 cursor-not allowed dark:bg-gray-800 dark:text-gray-400 dark:border-gray-700`;
  } else if (error) {
